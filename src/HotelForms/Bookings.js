    ...
    <div className="booking-form">
      ...
      <form onSubmit={handleSubmit}>
        <Input
          ...
          type="text"
          name="title"
          // value={formValues.title} ********* what's difference between value and defaultValue?
        ...
        <Input
          ...
          type="text"
          name="firstName"
          // value={formValues.firstName} ********* what's difference between value and defaultValue?
